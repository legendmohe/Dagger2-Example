...
public class LoginActivity extends BaseActivity {
    ...
    private static final String CONSTANT_ACCOUNT = "CONSTANT_ACCOUNT";
    /**
...
//            Application application = mApplicationComponent.application();
            mSharedPreferences.edit().putString(CONSTANT_ACCOUNT, mEmail).apply();
